...
class EtherscanApiController internal constructor(
  ...
  override suspend fun getTransactions(
    ...
    offset: Int,
    account: String
  ): List<EthereumTransactionBasic> = httpClient
    .tryGet<EtherTransactionsResponseDto>("") {
...
private fun EtherTransactionDto.basic(): EthereumTransactionBasic = EthereumTransactionBasic(
  hash = hash,
  amount = value,
  recipient = to,
  sender = from,
