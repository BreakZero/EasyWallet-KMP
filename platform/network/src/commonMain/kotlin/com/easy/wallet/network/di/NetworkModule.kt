...
import com.easy.wallet.network.source.evmrpc.EvmJsonRpcApiImpl
import com.easy.wallet.network.source.evmrpc.JsonRpcApi
...
private fun webSocketClient(config: HttpClientConfig<*>.() -> Unit = {}): HttpClient = httpClient {
  install(WebSockets) {
